...
// if (document.getElementById("chief_form")){
//     const chief_selector = document.getElementById("chief_form")
//     const subordinate_selector = document.getElementById("subordinate_selector")
//     const chief_list = document.getElementById("chief_list")
//     subordinate_selector.addEventListener('selectionchange', () => {
//       if (subordinate_selector.value === 'Reseller'){
//         let data = $.ajax
//         ({
//           type: "GET",
//           url: "index1.php",
...
//           chief_list.options[i].value = data[i]
//         }
//       }
//       else if (subordinate_selector.value === 'Sub Reseller'){
//         let data = $.ajax
//         ({
//           type: "GET",
//           url: "index1.php",
